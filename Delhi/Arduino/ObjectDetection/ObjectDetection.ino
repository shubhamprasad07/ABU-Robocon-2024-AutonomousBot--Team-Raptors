//if blue zone than omega= -25,  if red zone then omaega = 25
// check where the line follwer ends and add hard code for forward movement if needed
...
void pickupMechanism() {
  ...
  if (distance2 > 20)
  {
    ...
    {
      calculateWheelSpeedsObject(-50, 0, 0, speeds);
      setMotorSpeeds(speeds);
    }
    chisu = 1;
    Serial.println(chisu);
